...
==============================================================================*/
#ifndef INTELLGRAPH_SRC_EDGE_VERTEX_OUTPUT_VERTEX_H_
#define INTELLGRAPH_SRC_EDGE_VERTEX_OUTPUT_VERTEX_H_
...
public:
  ...
  virtual T CalcAccuracy(const Eigen::Ref<const MatrixX<T>> &labels) = 0;
  virtual void CalcDelta(const Eigen::Ref<const MatrixX<T>> &labels) = 0;
};

} // namespace intellgraph

#endif // INTELLGRAPH_SRC_EDGE_VERTEX_OUTPUT_VERTEX_H_
